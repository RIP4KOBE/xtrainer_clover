...
def arg_config():
    ...
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='./ckpt/act_tidying_up_bowls_b_0919',required=False)
    parser.add_argument('--task_name', action='store', type=str, default='act_tidying_up_bowls_b_0919', help='task_name', required=False)
    parser.add_argument('--batch_size', action='store', type=int, help='batch_size', default=16, required=False)
    parser.add_argument('--seed', action='store', type=int, help='seed', default=0,required=False)
    parser.add_argument('--num_steps', action='store', type=int, help='num_steps', default=14000, required=False)
    ...
    parser.add_argument('--resume_ckpt_path', action='store', type=str, help='resume_ckpt_path',
                        default= "./ckpt/act_tidying_up_bowls_b_resume_0919/policy_step_16000_seed_0.ckpt",required=False)
