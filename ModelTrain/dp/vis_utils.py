...
def visualize_trajectory(population_trajectories, best_trajectory):
    ...
    # Separate left and right arm joint angles
    left_arm_trajectories = population_trajectories[:, :, :6]  # (batch_size, prediction_horizon, 6)
    right_arm_trajectories = population_trajectories[:, :, 7:13]  # (batch_size, prediction_horizon, 6)

    best_left_arm = best_trajectory[:, :6]  # (prediction_horizon, 6)
    best_right_arm = best_trajectory[:, 7:13]  # (prediction_horizon, 6)
    ...
    # Setup figure with white background (same as vis_action)
    ...
    # Plot best trajectory with darker colors and thicker lines
    # ax.plot(best_left_ee_positions[0][:, 0],
    #         best_left_ee_positions[0][:, 1],
    #         best_left_ee_positions[0][:, 2],
    #         color="deeppink", linewidth=3.0, label="Best Left Trajectory", alpha=1.0)
    #
    # ax.plot(best_right_ee_positions[0][:, 0],
    #         best_right_ee_positions[0][:, 1],
    #         best_right_ee_positions[0][:, 2],
    #         color="green", linewidth=3.0, label="Best Right Trajectory", alpha=1.0)

    # Mark start points with larger markers (optional, uncomment if needed)
    # ax.scatter(best_left_ee_positions[0, 0, 0],
    #            best_left_ee_positions[0, 0, 1],
    #            best_left_ee_positions[0, 0, 2],
    #            color='deeppink', marker='o', s=50,
    #            edgecolors='darkred', linewidth=4,
    #            label='Left Start', alpha=1.0)

    # ax.scatter(best_right_ee_positions[0, 0, 0],
    #            best_right_ee_positions[0, 0, 1],
    #            best_right_ee_positions[0, 0, 2],
